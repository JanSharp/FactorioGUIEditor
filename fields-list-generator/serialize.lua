...
-- This file is from https://github.com/JanSharp/phobos
-- Honestly it should be an entirely separate and isolated project, but Phobos has several library
-- like files in it which would make it pretty tedious. Phobos also has a testing framework and this
-- file here is completely tested, so that's cool. And it's a pretty fast serializer because it does
-- not care about pretty printing. Serializing is its sole purpose.
-- In terms of licensing, well, I wrote this file and both projects are under the same license.
-- The copyright is technically different between the two, but like I said I wrote this file and
-- git history shows as much, so I can do whatever I want. Me being Jan.
